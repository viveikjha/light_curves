...
with open('lc_stats2.csv','w') as f:
    ...
    for i in range(0,len(gfiles)):
        ...
        try:
                ...
                ax1.plot(ndate,filtered_g,color='royalblue',marker='o',lw=0,markersize=10,markeredgecolor='black',markeredgewidth=1,label='g-band')
                ax1.errorbar(ndate,filtered_g, yerr = nerr, fmt =' ', color = 'royalblue',lw=1,capsize=0)
